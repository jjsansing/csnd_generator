...
class csgNote(object):

    def __init__(self, note_defs):
        sorted(note_defs, key=itemgetter(1))
...
class csgVowel(object):

    def __init__(self, vowel_defs):
        self.ids = numpy.array(sorted(vowel_defs, key=itemgetter(1)))
